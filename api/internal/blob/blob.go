// Package blob wraps the Azure Blob Storage client with the few operations this
// app needs, authenticating with the function app's managed identity.
package blob
...
func New(accountName string) (*Client, error) {
	...
	svc, err := azblob.NewClient(url, cred, nil)
	if err != nil {
